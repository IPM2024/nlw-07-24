...
let atividades = [
  ...
  },
  {
    ...
    data: new Date("2024-07-10 15:00"),
    finalizada: true
  }
]
...
const salvarAtividade = (event) => {
  ...
  if(atividadeExiste) {
    return alert('Dia ou Hora não disponíveis')
  }
